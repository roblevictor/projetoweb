...
<body>
    <div class="container mx-auto bg-light mt-1 w-90">
        <header class="row">
            ...
            <div class="col-sm-3">
                <img src="logo.jpg" width="200" height="200" alt="logotipo house of Burger colorido. ">
            </div>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./hamburger.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="hamburgervegetariano.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="combo.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Monte seu Combo</h5>
